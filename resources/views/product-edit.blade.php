...
@section('title','VrinVrogv - Edit Auction')
...
@section('main-content')
                ...
                <div class="border-0 mb-4">
                    ...
                    <h3 class="fw-bold mb-0">Edit Auction Details</h3>
                ...
                <div class="col-xl-8 col-lg-8">
                    ...
                    <div class="card-body">
                        <div class="row g-3 align-items-center">
                            ...
                            <input name="productName" type="text" class="form-control" placeholder="Enter Product Name"  value="{{ $product->name }}">
                            </div>
                            <div class="col-md-4" >
                                                <label  class="form-label">Categories</label>
                                                <select name="category" class="form-select" aria-label="Default select example">
                                                <option  value="{{ $product->category}}" selected readonly>{{ $product->category_name }}</option>    
                            ...
                            <div id="editor">
                                <textarea name="productDescription" type="text" class="form-control" placeholder="Enter Product Description">{{ $product->description }}</textarea>
                            </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-xl-4 col-lg-4">
                    ...
                    <div class="card mb-3">
                        ...
                        <div class="row g-3 align-items-center">
                            ...
                            <div class="input-group w-100">
                                <span class="input-group-text">₹</span>
                                <input name="bidIncrement" type="text" class="form-control" placeholder="10" value="{{ $product->bid_increment }}">
                            </div>
                            </div>
                        </div>
                        </div>
                    ...
                    <div class="card mb-3">
                        ...
                        <div class="row g-3 align-items-center">
                            ...
                            <input name="startingDate" type="date" class="form-control w-100" value="{{ $product->start_date }}">
                            </div>
                            <div class="col-md-12">
                            <label  class="form-label">Starting Time</label>
                            <input name="startingTime" type="time" class="form-control w-100" value="{{ $product->start_time }}">
                            </div>
                            <div class="col-md-12">
                            <label  class="form-label">Ending Date</label>
                            <input name="endingDate" type="date" class="form-control w-100" value="{{ $product->end_date }}">
                            </div>
                            <div class="col-md-12">
                            <label  class="form-label">Ending Time</label>
                            <input name="endingTime" type="time" class="form-control w-100" value="{{ $product->end_time }}">
                            </div>
                        </div>
                        </div>
                    </div>
