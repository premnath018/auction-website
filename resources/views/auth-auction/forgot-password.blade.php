...
<head>
    ...
    <title>VrinVrog - Forgot Password</title>
                    ...
                    <div class="row g-0">
                        ...
                        <div class="col-lg-6 d-flex justify-content-center align-items-center border-0 rounded-lg auth-h100">
                            <div class="w-100 p-3 p-md-5 card border-0 shadow-sm" style="max-width: 32rem;">
                                <!-- Form -->
                                <form class="row g-1 p-3 p-md-4" action="{{route ('auth.forgot-password')}}" method="POST">
                                    @csrf
                                    @if(session('message'))
                                    ...
                                    <div class="col-12 text-center mt-4">
                                        <span class="text-muted"><a href="{{ route('auth.login') }}" class="text-secondary">Back to Sign in</a></span>
                                    </div>
                                </form>
                                <!-- End Form -->
