...
<head>
    ...
    <title>VrinVrog - Dashboard</title>
        ...
        <div class="sidebar px-4 py-4 py-md-4 me-0">
            <div class="d-flex flex-column h-100">
                ...
                <ul class="menu-list flex-grow-1 mt-3">
                    ...
                    <li><a class="m-link active" href="index.html"><i class="icofont-code"></i> <span>Stater page</span></a></li>
                    <li class="collapsed">
                ...
                <div class="h-right d-flex align-items-center mr-5 mr-lg-0 order-1">
                    ...
                    <div class="dropdown zindex-popover">
                        <a class="nav-link dropdown-toggle pulse" href="#" role="button" data-bs-toggle="dropdown">
                            <img src="{{asset('images/flag/GB.png')}}" alt="">
                        </a>
                        <div class="dropdown-menu rounded-lg shadow border-0 dropdown-animation dropdown-menu-md-end p-0 m-0 mt-3">
                            <div class="card border-0">
                                <ul class="list-unstyled py-2 px-3">
                                    <li>
                                        <a href="#" class=""><img src="{{asset('images/flag/GB.png')}}" alt=""> English</a>
                                    </li>
                                    <li>
                                        <a href="#" class=""><img src="{{asset('images/flag/DE.png')}}" alt=""> German</a>
                                    </li>
                                    <li>
                                        <a href="#" class=""><img src="{{asset('images/flag/FR.png')}}" alt=""> French</a>
                                    </li>
                                    <li>
                                        <a href="#" class=""><img src="{{asset('images/flag/IT.png')}}" alt=""> Italian</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="col-12">
                        <div class="card mb-3">
                            <div class="card-body text-center p-5">
                                <img src="{{asset('images/no-data.svg')}}" class="img-fluid mx-size" alt="No Data">
                                <div class="mt-4 mb-2">
...
<!-- Mirrored from pixelwibes.com/template/ebazar/html/dist/ui-elements/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 21 Jul 2023 13:17:17 GMT -->
</html>